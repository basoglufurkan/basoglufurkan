...
- 📱 iOS geliştirme alanında uzmanlaşmış bir mobil uygulama geliştiricisiyim
  ...
  - - 🌱 **SwiftUI**, **UIKit** ve **Combine** framework'lerini öğrenmeye devam ediyorum
    - - 💡 Marvel, Film ve Uzay konularına ilgim var — bunları uygulama projelerime yansıtıyorum
      - - 📫 GitHub üzerinden ulaşabilirsiniz: [@basoglufurkan](https://github.com/basoglufurkan)
        ...
        |-------|----------|-----------|
        | 🎬 [MovieTimeApp](https://github.com/basoglufurkan/MovietimeApp) | Film zamanlama iOS uygulaması | Swift 5.9 |
        | 🎭 [Movie-Poster-App](https://github.com/basoglufurkan/Movie-Poster-App) | Film poster görüntüleyici | Swift 5.9 |
        | 🦸 [MarvelComics](https://github.com/basoglufurkan/MarvelComics) | Marvel çizgi roman uygulaması | Swift 5 |
        | 📞 [VirtualNumberApp](https://github.com/basoglufurkan/VirtualNumberApp) | Sanal numara yönetim uygulaması | Swift 5.9 |
        | 🛒 [ProductDetailApp](https://github.com/basoglufurkan/ProductDetailApp) | Ürün detay uygulaması | Swift 5.9 |
        | 🚀 [Nasa-Vehicles](https://github.com/basoglufurkan/Nasa-Vehicles) | NASA araçları görüntüleyici | Swift 5 |
